...
public class BattleFrame extends JFrame {
	...
	public BattleFrame()  {
		...
		movePP = new JLabel("PP:" + playerPokemon.getMove1().getCharges() + "/" + playerPokemon.getMove1().getMaxCharges());
	...
	/*private void updateAllyStatuses() {
		...
		for (Map.Entry<Status, Integer> entry : playerPokemon.getStatuses().entrySet()) {
			switch(entry.getKey()) {
			case ASLEEP:
				break;
			case NORMAL:
